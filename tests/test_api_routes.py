...
Note: These tests are slow due to ML model loading.
Use: pytest tests/test_api_routes.py -m "not slow" to skip
"""
...
class TestWaitlistRoutes:
    ...
    def test_join_waitlist_invalid_email(self):
        ...
        response = self.client.post("/api/v1/waitlist/waitlist", json={"email": "invalid-email"})
    ...
    def test_join_waitlist_missing_email(self):
        ...
        response = self.client.post("/api/v1/waitlist/waitlist", json={"source": "landing_page"})
...
class TestOrderRoutes:
    ...
    def test_create_order(self):
        ...
        response = self.client.post(
            "/api/v1/orders",
            json={"symbol": "BTCUSDT", "side": "buy", "quantity": 0.1, "price": 50000},
        )
