...
# ==================== SIMULATION MODE ====================
# Auto-detect: simulation if no API keys, or if SIMULATION_MODE=true
_has_api_keys = bool(os.getenv("BINANCE_API_KEY") and os.getenv("BINANCE_SECRET_KEY"))
SIMULATION_MODE: bool = os.getenv("SIMULATION_MODE", "true").lower() != "false" or not _has_api_keys
