...
1. [ ] **feat(security)**: add audit logging to orders/portfolio/risk routes (app/main.py + app/core/audit.py)
2. [ ] **feat(security)**: /api/v1/rate-limit/stats endpoint (app/api/rate_limit.py)
3. [ ] **chore(security)**: security headers tests (tests/integration/test_api_security.py)
4. [ ] **fix(security)**: harden CSP/X-Frame middleware (app/core/security_middleware.py)
5. [ ] **docs(security)**: API docs update (docs/API_DOCS.md, README.md)
...
12. [ ] **test(perf)**: pytest-benchmark (tests/test_backtest.py, pytest.ini)
